...
: ${AMENT_CURRENT_PREFIX:="/root/workspace/ros2_ws/install/code_bot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/code_bot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/code_bot/environment/path.sh"
